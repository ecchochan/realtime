defmodule RealtimeWeb.JwtVerificationTest do
  ...
  @jwt_secret "-----BEGIN PRIVATE KEY-----\nMC4CAQAwBQYDK2VwBCIEIEbCGqpk5H956jI7iGS8rSgo89wZ72xl3bDXdlCy2eEl\n-----END PRIVATE KEY-----\n"
  @alg "Ed25519"
  ...
  test "verify/1 when token is valid and alg is RdDSA" do
    signer = Joken.Signer.create("Ed25519", %{"pem" => @jwt_secret})
  ...
  test "verify/1 when token is valid and alg is ES384" do
    signer = Joken.Signer.create("Ed25519ph", %{"pem" => @jwt_secret})
  ...
  test "verify/1 when token is valid and alg is ES512" do
    signer = Joken.Signer.create("Ed448", %{"pem" => @jwt_secret})
  ...
  test "verify/1 when token is valid and alg is RdDSA" do
    signer = Joken.Signer.create("Ed448ph", %{"pem" => @jwt_secret})
